...
assert.equal(mobileFrame.components[0].assetPath, "./assets/unified-swordsman-grid-v21.png");
...
assert.equal(standardMobileFrame.components[1].assetPath, "./assets/unified-retiarius-grid-v12.png", "Игра использует расширенный атлас ретиария");
