...
const UNIFIED_SWORDSMAN_GRID_ID = "unified-swordsman-v21";
const UNIFIED_RETIARIUS_GRID_ID = "unified-retiarius-v12";
...
const BODY_ANIMATION_GRIDS = Object.freeze({
  [UNIFIED_SWORDSMAN_GRID_ID]: Object.freeze({
    ...
    assetPath: "./assets/unified-swordsman-grid-v21.png",
    facing: "right",
    renderable: true,
    experimental: true,
    grid: UNIFIED_ATLAS,
  ...
  [UNIFIED_RETIARIUS_GRID_ID]: Object.freeze({
    ...
    assetPath: "./assets/unified-retiarius-grid-v12.png",
    facing: "right",
    renderable: true,
    experimental: true,
