...
Постоянный перк, классовый оружейный приём, дополнительный эффект снаряжения, временный
...
`instanceId` отличают постоянный перк от классового оружейного приёма, дополнительного перка
